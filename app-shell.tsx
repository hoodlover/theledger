    ...
    <div className="flex min-h-full bg-[var(--background)]">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[color-mix(in_oklab,var(--background)_92%,transparent)] backdrop-blur">
          <div className="mx-auto max-w-[1600px] flex items-center justify-between gap-4 px-4 lg:px-6 py-3">
            <div className="flex items-center gap-2 min-w-0">
              <MobileNav items={PRIMARY_NAV} bottomItems={SECONDARY_NAV} />
              {/* Mobile brand — the desktop brand lives in the sidebar */}
              <Link
                href="/"
              ...
              {scope.entity ? (
                <span className="hidden md:inline-flex items-center gap-2 rounded-full bg-[var(--surface-warm)] border border-[var(--border)] px-3 py-1 text-xs text-[var(--body)]">
                  <span
                    aria-hidden
        ...
        <main className="flex-1">
          <div className="mx-auto max-w-[1600px] px-4 py-5 lg:px-6 lg:py-8">{children}</div>
        </main>
